...
export function ChatInput({ onSend }: ChatInputProps) {
  ...
  return (
    <View
      className="flex-row rounded-xl items-center mx-4 px-4 py-2.5 my-4 gap-1 border border-white/10"
      style={{
    ...
    >
      <View className="flex-1 flex-row items-center rounded-full px-4">
        <RNTextInput
          className="flex-1 text-lg text-black/80 border-0 pb-1 pt-0"
