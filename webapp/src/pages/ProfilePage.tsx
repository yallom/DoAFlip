...
import { User, MapPin, Edit, AlertTriangle, Plus, ChevronRight, Lock, Bell, Shield, LogOut, X, ArrowLeft, ArrowRight, Loader2 } from 'lucide-react';
              ...
              <div className="mb-8">
                <div className="flex items-center justify-center gap-4 mb-6">
                  <div className="flex flex-col items-center">
                    ...
                    <span className={`text-xs font-medium ${editStep >= 1 ? 'text-primary-green' : 'text-dark-green-1/50'
                      }`}>PERSONAL</span>
                  </div>

                  <div className={`w-16 h-0.5 mb-6 ${editStep >= 2 ? 'bg-primary-green/30' : 'bg-dark-green-1/20'
                    }`}></div>
                  ...
                  <div className="flex flex-col items-center">
                    ...
                    <span className={`text-xs font-medium ${editStep >= 2 ? 'text-primary-green' : 'text-dark-green-1/50'
                      }`}>DIETARY</span>
                  </div>
                </div>
                      ...
                      {[
                        ...
                        >
                          <div className="flex items-center justify-between">
                            <div>
                              <div className={`font-semibold mb-1 ${dietaryPreferences.includes(pref.value) ? 'text-primary-green' : 'text-dark-green-2'
                                }`}>
                                {pref.label}
                              </div>
