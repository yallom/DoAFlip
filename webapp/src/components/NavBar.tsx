                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-2 md:gap-0">
                            ...
                            <div className="relative">
                                ...
                                >
                                    <span className="hidden sm:block text-dark-green-2 font-medium text-sm">{user?.name}</span>
                                    ...
                                    <ChevronDown
                                        className={`hidden sm:block w-4 h-4 text-dark-green-1 transition-transform ${isMenuOpen ? 'rotate-180' : ''
                                            }`}
                                    />
                                </button>
